        ...
        <PlaceHolder ref={element} id='product'>
          <ProductContainer className={show && 'trigger'}>
            <ImgPlaceholder>
              <Img
                width='100%'
                src='/static/images/mango-medium.jpg'
                alt='mango kent'
              />
            </ImgPlaceholder>
            <ProductDescription>
              ...
              <Text>
                Mango kent is a fruit with an excelent flavor, very low on carbs
                and fibers, and the widest variety of escensial minerals and
                vitamins
              </Text>
              <Link route='/recipes'>
